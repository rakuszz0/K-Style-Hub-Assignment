...
const docTemplate = `{
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/ecommerce_dto_cart.CartRequest"
                        }
                    }
                ],
                "responses": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/handlers.OrderPaginationResponse"
                                        }
                                    }
                                }
                            ]
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/ecommerce_dto_order.OrderRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "ecommerce_dto_cart.CartRequest": {
            "type": "object",
            "properties": {
                "product_id": {
                    "type": "integer"
        ...
        "ecommerce_dto_cart.CartResponse": {
            ...
            "properties": {
                ...
                "product": {
                    "$ref": "#/definitions/ecommerce_dto_cart.Product"
                },
                "product_id": {
                    "type": "integer"
                },
        ...
        "ecommerce_dto_order.OrderRequest": {
            "type": "object",
            "properties": {
                "product_id": {
                    "type": "integer"
        ...
        "ecommerce_dto_order.OrderResponse": {
            ...
            "properties": {
                ...
                "product": {
                    "$ref": "#/definitions/ecommerce_dto_order.Product"
                },
                "product_id": {
                    "type": "integer"
                },
        ...
        "handlers.OrderPaginationResponse": {
            "type": "object",
            "properties": {
                "has_next": {
                    "type": "boolean"
